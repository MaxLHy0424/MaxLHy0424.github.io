...
export const siteConfig: SiteConfig = {
    title: "MaxLHy's Blog",
    subtitle: "",
    siteURL: "https://maxlhy0424.is-a.dev/", // 请替换为你的站点URL，以斜杠结尾
    siteStartDate: "2024-06-20", // 站点开始运行日期，用于站点统计组件计算运行天数
...
export const navBarConfig: NavBarConfig = {
    links: [
        ...
        //         {
        //             name: "GitHub",
        //             url: "https://github.com/MaxLHy0424",
        //             external: true,
        //             icon: "fa7-brands:github",
        //         },
        //         {
        //             name: "Bilibili",
        //             url: "https://space.bilibili.com/1678066522",
        //             external: true,
...
export const commentConfig: CommentConfig = {
    ...
    twikoo: {
        envId: "https://maxlhy0424-blog.netlify.app/.netlify/functions/twikoo",
        lang: SITE_LANG,
    },
};
...
export const announcementConfig: AnnouncementConfig = {
    title: "已知问题", // 公告标题，填空使用i18n字符串Key.announcement
    content: "评论功能在中国大陆地区可用性不佳，如显示错误 “评论失败: 0”，请尝试多次点击 “发送” 或使用海外代理访问本站。", // 公告内容
...
export const footerConfig: FooterConfig = {
    ...
    customHtml:
        '<a href="https://icp.gov.moe/?keyword=20264096" target="_blank">萌 ICP 备 20264096 号</a> • <a href="https://travel.moe/go.html?travel=on" target="_blank">异次元之旅</a>',
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
    ...
    // 侧栏组件布局配置
    components: {
        left: ["profile", "announcement", "categories", "tags", "site-stats", "calendar"],
        right: [],
...
export const pioConfig: import("./types/config").PioConfig = {
    ...
    dialog: {
        welcome: "Welcome to MaxLHy's Blog!", // 欢迎词
        touch: [
            "What are you doing?",
            "Stop touching me!",
            "HENTAI!",
        ...
        link: "https://github.com/MaxLHy0424/", // 关于链接
    },
};
