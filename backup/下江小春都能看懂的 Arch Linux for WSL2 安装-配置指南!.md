在 Windows 上开发 Linux 软件时, WSL2 常常是不二之选.

但是, WSL2 上开箱即用的 Linux 发行版, 几乎都是 Debian 系的. 用户想要在 WSL2 上使用 Arch Linux, 连配置部分就已经难道了一大批人...
...
WSL2 的硬件要求及启用方法在此处不多赘述, 请自行查阅.

> 如果您有安装 VMware Workstation, Oracle Vitrual Box 等寄居型虚拟机, 推荐改用 Hyper-V. 否则其运行的虚拟机性能可能会受到影响.
